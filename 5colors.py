...
colors[3][0] = random.randint(0, 255)
colors[3][1] = random.randint(0, 255)
colors[3][2] = random.randint(0, 255)
colors[4][0] = random.randint(0, 255)
colors[4][1] = random.randint(0, 255)
colors[4][2] = random.randint(0, 255)
...
def getNeighbours(image, colors, step):
    ...
    for x in range(3):
        while True:
            a, b, c, d, e, f, g, h, i, j, k, l, m, n, o = random.randint(-y, y), random.randint(-y, y), random.randint(-y, y), \
            ...
            if (0 <= colors[0][0] + a <= 255) and (0 <= colors[0][1] + b <= 255) and (0 <= colors[0][2] + c <= 255)\
                    ...
                    and (0 <= colors[3][0] + i <= 255)and (0 <= colors[3][1] + i <= 255) and (0 <= colors[3][2] + i <= 255)\
                    and (0 <= colors[4][0] + i <= 255)and (0 <= colors[4][1] + i <= 255) and (0 <= colors[4][2] + i <= 255):
                colors[0][0] += a
                colors[0][1] += b
                colors[0][2] += c
                colors[1][0] += d
